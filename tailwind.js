["linear", "radial", "conic"],
    ...
    [
      ...
      "placeholder-base-600",
      "placeholder-base-700",
      "placeholder-base-800",
      "placeholder-base-900",
      "placeholder-base-950"
    ],
    [
      "bg-primary-50",
      "bg-primary-100",
    ...
    [
      ...
      "ring-offset-base-400",
      "ring-offset-base-500",
      "ring-offset-base-600",
      "ring-offset-base-700",
      "ring-offset-base-800",
      "ring-offset-base-900",
      "ring-offset-base-950"
    ],
    [
      "shadow-primary-50",
      "shadow-primary-100",
    ...
    ["font-starjedi", "font-starjedihollow", "font-starjedirounded"],
    [
      "font-a",
      "font-b",
      "font-c",
    ...
    ["flex-1", "flex-auto", "flex-inital", "flex-none"],
    ...
    ["auto-row-auto", "auto-row-min", "auto-row-max", "auto-row-fr"],
    [
      "gap-0",
      "gap-1",
      "gap-2",
    ...
    ["backdrop-grayscale-0", "backdrop-grayscale-none"],
    [
    ...
    ["group", "group-hover", "group-active", "group-focus", "group-odd"],
    ["peer", "peer-invalid", "peer-required", "peer-disabled", "peer-hover"],
    ["before", "after"],
